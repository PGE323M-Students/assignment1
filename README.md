...
It should be obvious, but substitute "PGE323" anywhere you see "PGE383" in the video.
...
at the Terminal command prompt.  A status message of `OK` indicates you have the correct answer.
